...
var HTabController=(function(){
	var CLASS=function HTabController(sequenceLayout){
    	Base.call(this,['HTabController']);
		var _THIS=this;
		Widget.call(this);
		var tbody,table,tr;
...
var VTabController=(function(){
	var CLASS=function VTabController(sequenceLayout){
    	Base.call(this,['VTabController']);
		var _THIS=this;
		Widget.call(this);
		var tbody,table,tr;
		this.View(table=MAKE.table({className:'TabController'},{borderCollapse:'collapse'}
...
var SequenceController=(function(){
	var CLASS=function SequenceController(sequenceLayout){
    	Base.call(this,['SequenceController']);
		var _THIS=this;
		Widget.call(this);
		var tbody,table;
