...
<link
	rel=stylesheet href="doc/docs.css">
<link
	rel="stylesheet"
	href="lib/codemirror.css">
<link
	rel="stylesheet"
	href="addon/hint/show-hint.css">
<script
	src="lib/codemirror.js"></script>
<script
	src="addon/hint/show-hint.js"></script>
<script
	src="addon/hint/xml-hint.js"></script>
<script
	src="addon/hint/html-hint.js"></script>
<script
...
APP=(function(){
	return function APP(){
		...
		setTimeout(function(){
			var text=doc.body.parentNode.innerHTML;
		
			var editor = CodeMirror(document.getElementById("editor_wrap"), {
				mode: "text/html",
				lineNumbers:true,
				value: text
			});
			/*var func=function(){
				setTimeout(function(){
					try{
						editor.doc.setSelection({line:"<?php echo $line; ?>",ch:1},{line:"<?php echo $line; ?>",ch:400});
					}catch(err){
						func();
					}
				},100);
...
<body onload='setTimeout(function(){new APP()},2000)'>
	<div id="editor_wrap"><?php echo $addr; ?></div>
	<iframe id="page_frame" src="<?php echo $addr.'?innerframe=true'; ?>" style="display:none;"></iframe>
